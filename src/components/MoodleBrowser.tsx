...
export default function MoodleBrowser({ 
        ...
        if (res.ok) {
          ...
          if (data.details) {
            ...
            const newTodo: TodoTask = {
              ...
              gradingStatus: (computedStats.grade || computedStats.status === 'Calificado' || (details.estado_calificacion && details.estado_calificacion.toLowerCase().includes('calificad'))) ? 'Calificado' : (details.estado_calificacion || null),
  ...
  const importSingleActivity = () => {
    ...
    const newTodo: TodoTask = {
      ...
      grade: computedStats.grade,
      gradeOver: computedStats.gradeOver,
      gradingStatus: (computedStats.grade || computedStats.status === 'Calificado' || (activityDetails.estado_calificacion && activityDetails.estado_calificacion.toLowerCase().includes('calificad'))) ? 'Calificado' : (activityDetails.estado_calificacion || null),
